...
public class DraggrARSession implements UpdateCallbackInterface
{
    ...
    private DraggrARControl m_sessionControl;
    ...
    public DraggrARSession(DraggrARControl sessionControl)
    {
    ...
    private class LoadTrackerTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            } else
            {
                ...
                Vuforia.registerCallback(DraggrARSession.this);
